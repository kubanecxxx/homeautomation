...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonShell = QtGui.QPushButton(self.groupBox)
        self.buttonShell.setObjectName(_fromUtf8("buttonShell"))
        self.formLayout.setWidget(9, QtGui.QFormLayout.SpanningRole, self.buttonShell)
        self.plainReturn = QtGui.QPlainTextEdit(self.groupBox)
        self.plainReturn.setReadOnly(True)
        self.plainReturn.setObjectName(_fromUtf8("plainReturn"))
        self.formLayout.setWidget(8, QtGui.QFormLayout.SpanningRole, self.plainReturn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttonShell.setText(_translate("MainWindow", "Shell", None))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Filtering", None))
